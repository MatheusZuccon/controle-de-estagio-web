...
@Component({ standalone: true, imports: [CommonModule, ReactiveFormsModule, MatError], styleUrl: './student-profile.component.scss', templateUrl: './student-profile.component.html' })
export class StudentProfileComponent implements OnInit {
  ...
  photo?: File; photoPreview = ''; error = ''; submitted = false;
  form = this.fb.group({
    ...
    course: ['', Validators.required], identity: ['', [Validators.required, Validators.maxLength(50)]], cpf: ['', [Validators.required, this.cpfValidator]], academicPeriod: ['', Validators.required], educationLevel: ['', Validators.required],
  });
